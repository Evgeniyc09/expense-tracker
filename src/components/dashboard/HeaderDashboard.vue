			...
			>
				...
				<div class="hidden sm:block">
					...
					<div class="relative min-w-72 md:min-w-80">
						...
						>
							<svg
								class="flex-shrink-0 size-4 text-gray-400 dark:text-neutral-400"
								xmlns="http://www.w3.org/2000/svg"
								width="24"
								height="24"
								viewBox="0 0 24 24"
				...
				<div class="flex flex-row items-center justify-end gap-2">
					...
					>
						...
						>
							<div
								class="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg dark:bg-neutral-800"
							>
								<p class="text-sm text-gray-500 dark:text-neutral-400">
									Signed in as
								</p>
								<p
									class="text-sm font-medium text-gray-800 dark:text-neutral-300"
								>
									james@site.com
								</p>
							</div>
